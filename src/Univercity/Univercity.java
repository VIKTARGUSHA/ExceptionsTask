...
public String name;
    ...
    public double mathTotalAverage(Stack<? extends Univercity> studentStack) throws NoItemsException, NegativeAndAboveScoreException {
        ...
        for (Univercity thisStudent : studentStack) {
            ...
            if (thisStudent.phisicalScore != "None" && Double.parseDouble(thisStudent.foreignLenguageScore) < 0 || Double.parseDouble(thisStudent.foreignLenguageScore) > 10) {
            ...
            return mathTotalUnivercity / studentStack.size();
    }

    double foreignLanguageTotalForThisGroup(Stack<Univercity> studentStack, String speciality, String facultetName) throws NoItemsException, NegativeAndAboveScoreException {
        ...
        for (Univercity univercity : studentStack) {
            ...
            if (univercity.foreignLenguageScore != "None" && Double.parseDouble(univercity.phisicalScore) < 0 || Double.parseDouble(univercity.phisicalScore) > 10) {
            ...
            if (Double.parseDouble(univercity.mathScore) < 0 || Double.parseDouble(univercity.mathScore) > 10) {
                throw new NegativeAndAboveScoreException(univercity.name, "this Student has Math score out of range", univercity.mathScore);
            }
            if (Double.parseDouble(univercity.foreignLenguageScore) < 0 || Double.parseDouble(univercity.foreignLenguageScore) > 10) {
            ...
            if (univercity.speciality == speciality && univercity.facultetName == facultetName) {
                ...
                totalForeignLanguageThisGroup += univercity.foreignLenguageScore == "None" ? 0.0 : Double.parseDouble(univercity.studentForeignLanguageMark);
            }
        }
    ...
    public double averageScoreForThisStudent(Univercity univercity) throws NoItemsException, NegativeAndAboveScoreException {
        ...
        if (Double.parseDouble(univercity.phisicalScore) < 0 || Double.parseDouble(univercity.phisicalScore) > 10) {
            throw new NegativeAndAboveScoreException(univercity.name, "this Student has Phisical score out of range", univercity.phisicalScore);
        }
        if (Double.parseDouble(univercity.mathScore) < 0 || Double.parseDouble(univercity.mathScore) > 10) {
            throw new NegativeAndAboveScoreException(univercity.name, "this Student has Math score out of range", univercity.mathScore);
    ...
    public static void main(String[] args) {
        ...
        StudentBiologyFacGroup01 secondStudentBiologyFacGroup01 = new StudentBiologyFacGroup01("Abukhovich Viktar", "9.0", "1.2", "4.4");
        studentsStack.push(secondStudentBiologyFacGroup01);
        StudentBiologyFacGroup01 thirdStudentBiologyFacGroup01 = new StudentBiologyFacGroup01("Eglit Viktar", "4.4", "8.9", "7.6");
        studentsStack.push(thirdStudentBiologyFacGroup01);
        StudentBiologyFacGroup02 firstStudentBiologyFacGroup02 = new StudentBiologyFacGroup02("Mahmud Abass", "3.4", "9.0", "0.3");
        ...
        StudentBiologyFacGroup03 thirdStudentBiologyFacGroup03 = new StudentBiologyFacGroup03("Ramzan Zan Zan", "3.0", "0.1", "5.5");
        ...
        StudentPhisFacGroup01 thirdStudentPhisFacGroup01 = new StudentPhisFacGroup01("Rashford Viktar", "4.1", "0.9", "8.4");
        ...
        try {
            System.out.printf("Total Foreign language score for any group" + "  :  " + "%.2f", univercity.foreignLanguageTotalForThisGroup(studentsStack, "MicroBiology", "Biology Facultet"));
        }catch (NoItemsException ex){
        }
        catch (NegativeAndAboveScoreException e) {
        }
